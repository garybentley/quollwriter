...
public class WarmupPromptSelect extends Box
{
    ...
    public WarmupPromptSelect(AbstractViewer v)
    {
        ...
        this.ownPrompt = UIUtils.createTextArea (getUIString (dowarmup,ownprompt,tooltip),
    ...
    public void init ()
    {
        ...
        List<String> prefix = Arrays.asList (dowarmup);
        ...
        this.add (UIUtils.createBoldSubHeader (getUIString (prefix,chooseprompt,title),
                                               //"Choose a prompt",
                                               null));
        ...
        final JCheckBox doNotShow = UIUtils.createCheckBox (getUIString (prefix,noshowpromptagain));
                                                   //"Do not show this prompt again");
        doNotShow.setOpaque (false);

        final JButton links = UIUtils.createButton (Environment.getIcon ("website-links",
                                                    Constants.ICON_MENU));
        links.setToolTipText (getUIString (prefix,weblinks,tooltip));
        ...
        links.addActionListener (new ActionAdapter ()
            {
                ...
                public void actionPerformed (ActionEvent ev)
                {
                    ...
                    for (PromptWebsite w : ws)
                    {
                        ...
                        item.setToolTipText (String.format (getUIString (prefix,weblinks,visitlink),
        ...
        JButton prev = UIUtils.createButton (Environment.getIcon ("previous",
                                                                  Constants.ICON_MENU));
        prev.setToolTipText (getUIString (prefix,previousprompt,tooltip));
                ...
                public void actionPerformed (ActionEvent ev)
                {
                    ...
                    } else
                    {
                        ...
                        UIUtils.showMessage (_this,
                                             getUIString (prefix,allpromptsexcluded));
        ...
        JButton next = UIUtils.createButton (getUIString (prefix,nextprompt,text),
                                             //"Next prompt",
                                             "next");
        ...
        next.setToolTipText (getUIString (prefix,nextprompt,tooltip));
        ...
        this.add (UIUtils.createBoldSubHeader (getUIString (prefix,ownprompt,title),
...
*/
        this.add (UIUtils.createBoldSubHeader (getUIString (prefix,dofor,title),
        ...
        builder.addLabel (getUIString (prefix,andor),
                          //"and/or",
                          cc.xy (3,
                                 1));
        ...
        builder.addLabel (getUIString (prefix,whicheverfirst),
...
*/
        ...
        JButton start = UIUtils.createButton (getUIString (prefix,startwriting),
                                              //"Start Writing",
                                              new ActionListener ()
        {
            ...
            public void actionPerformed (ActionEvent ev)
            {
                ...
                } catch (Exception e)
                {
                    ...
                    UIUtils.showErrorMessage (_this,
                                              getUIString (prefix,getwarmupsprojecterror));
                ...
                if (p != null)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        UIUtils.showErrorMessage (_this,
                                                  getUIString (prefix,openwarmupsprojecterror));
                    ...
                    UIUtils.showMessage (null,
                                         getUIString (prefix,createwarmupsproject,title),
                                         //"{Warmups} project",
                                         getUIString (prefix,createwarmupsproject,text),
                                            ...
                                            public void actionPerformed (ActionEvent ev)
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    UIUtils.showErrorMessage (null,
                                                                              getUIString (prefix,createwarmupsproject,actionerror));
        ...
        JButton cancel = UIUtils.createButton (getUIString (buttons, LanguageStrings.cancel),
                                               new ActionListener ()
        {
        ...
        UIUtils.doLater (new ActionListener ()
        {
            ...
            public void actionPerformed (ActionEvent ev)
            {
                ...
                } catch (Exception e)
                {
                    ...
                    UIUtils.showErrorMessage (null,
                                              getUIString (dowarmup,getwarmupsprojecterror));
                                              //"Unable to get {Warmups} {project}.");
                ...
                try
                {
                    ...
                    UIUtils.showErrorMessage (null,
                                              getUIString (dowarmup,addwarmuperror));
    ...
    public static JComboBox getTimeOptions (int minsC)
    {
        ...
        minsV.add (getUIString (times,unlimited));
        //"Unlimited");
        minsV.add (getUIString (times,mins10));
        //minsV.add ("10 minutes");
        minsV.add (getUIString (times,mins20));
        //minsV.add ("20 minutes");
        minsV.add (getUIString (times,mins30));
        //minsV.add (WarmupPromptSelect.DEFAULT_MINS); // 30 minutes
        minsV.add (getUIString (times,hour1));
        //minsV.add ("1 hour");
    ...
    public static JComboBox getWordsOptions (int wordsC)
    {
        ...
        wordsV.add (getUIString (LanguageStrings.words,unlimited));
        //wordsV.add ("Unlimited");
        wordsV.add (getUIString (LanguageStrings.words,words100));
        //wordsV.add ("100 words");
        wordsV.add (getUIString (LanguageStrings.words,words250));
        //wordsV.add ("250 words");
        wordsV.add (getUIString (LanguageStrings.words,words500));
        //wordsV.add (WarmupPromptSelect.DEFAULT_WORDS); // 500 words
        wordsV.add (getUIString (LanguageStrings.words,words1000));
    ...
    public static JCheckBox getDoWarmupOnStartupCheckbox ()
    {
        ...
        final JCheckBox doOnStartup = UIUtils.createCheckBox (getUIString (dowarmup,dowarmuponstart));
