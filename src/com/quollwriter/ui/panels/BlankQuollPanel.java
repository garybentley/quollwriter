...
*/
        ...
        Header header = UIUtils.createHeader (Environment.getUIString (LanguageStrings.noobjectselectedpanel,
                                                                       LanguageStrings.title),
                                                                       //"No {chapter}/{asset}/panel selected",
        ...
        JComponent help = UIUtils.createHelpTextPane (Environment.getUIString (LanguageStrings.noobjectselectedpanel,
                                                                               LanguageStrings.text),
                                                                       //"<p>You are seeing this because no {chapter}/{asset}/panel has been selected.</p><p>This usually happens when you have just deleted the item you were viewing.</p><p>To continue, just <a href='action:projectsidebar'>select an item from the sidebar</a>.</p>",
                                                      this.viewer);
