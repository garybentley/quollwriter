...
public class AdvertiseProjectPanel extends QuollPanel 
{
               ...
               throws GeneralException
    {
        ...
        EditorsWebServiceHandler wsHandler = Environment.getEditorsWebServiceHandler ();
        
        EditorAccount acc = Environment.getEditorsWebServiceHandler ().getAccount ();
        ...
        EditorProject proj = this.projectViewer.getProject ().getEditorProject ();
    ...
    private void createAccount ()
    {
        ...
        new Thread (new Runnable ()
        {
            ...
            public void run ()
            {
                ...
                try
                {
                    ...
                    Environment.getEditorsAuthorAvatarImageFile ().delete ();
                
                    EditorsWebServiceHandler h = Environment.getEditorsWebServiceHandler ();
        ...
        System.out.println ("CREATED/SAVED AUTHOR");
                    ...
                    h.saveProject (_this.titleF.getValue (),
