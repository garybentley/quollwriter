...
public class Notification extends HBox
{
    ...
    private Notification (Builder builder)
    {
        ...
        this.close.getStyleClass ().add (StyleClassNames.CLOSE);
        UIUtils.setTooltip (this.close,
                            getUILanguageStringProperty (notifications,remove,tooltip));

        this.getChildren ().add (this.close);
