...
public class DefaultEditorsWebServiceErrorAction implements EditorsWebServiceAction
{
                                               ...
                                               ActionListener          onCancel)
    {
        ...
        if (res.getErrorType ().equals ("InvalidCredentials"))
        {
            ...
            EditorsUIUtils.showLoginError ("Your login details do not appear to be correct.",
                                           onLogin,
                                           onCancel);
        ...
        if (res.getErrorType ().equals ("AccountNotActive"))
        {
            ...
            EditorsUIUtils.showLoginError ("You must activate your account (check your email) first.");
