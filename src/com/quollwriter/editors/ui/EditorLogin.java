...
public class EditorLogin extends QPopup implements UserOnlineStatusListener
{
    ...
    public EditorLogin ()
    {
        ...
        super (getUIString (editors,login,popup,title),
               //"Login to the Editors service",
        ...
        this.logginIn = UIUtils.createLoadingLabel (getUIString (editors,login,popup,loading));
    ...
    public void init ()
    {
        ...
        final JButton loginBut = UIUtils.createButton (getUIString (editors,login,popup,buttons,login));
        //"Login");
        ...
        builder.addLabel (getUIString (editors,login,popup,labels,youremail),
                          //"Your Email",
                          cc.xy (2,
                                 row));
        ...
        builder.addLabel (getUIString (editors,login,popup,labels,password),
                          //"Password",
                          cc.xy (2,
                                 row));
        ...
        this.autoLogin = UIUtils.createCheckBox (getUIString (editors,login,popup,labels,autologin));
        //"Automatically login whenever Quoll Writer starts");
        ...
        JButton cancelBut = UIUtils.createButton (getUIString (editors,login,popup,buttons,cancel),
