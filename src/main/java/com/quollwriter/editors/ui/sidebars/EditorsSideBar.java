                                                                               ...
                                                                               UserOnlineStatusListener
{
    ...
    public List<JComponent> getHeaderControls ()
    {
        ...
        this.statusButton = UIUtils.createButton (this.getStatusIconName (EditorEditor.OnlineStatus.offline),
                                                  Constants.ICON_SIDEBAR,
                                                  getUIString (editors,sidebar,headercontrols,items,onlinestatus,offline,button,tooltip),
                                                  //"Click to go online",
                                                  null);
        ...
        this.statusButton.addActionListener (new ActionListener ()
        {
            ...
            public void actionPerformed (ActionEvent ev)
            {
                ...
                if (EditorsEnvironment.isUserLoggedIn ())
                {
                    ...
                    JMenuItem mi = UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,onlinestatus,popupmenu,items,logout),
                                                            //"Logout",
...
/*
  ...
  */
        JButton b = UIUtils.createButton (Constants.NEW_ICON_NAME,
                                          Constants.ICON_SIDEBAR,
                                          getUIString (editors,sidebar,headercontrols,items,sendinvite,tooltip),
        ...
        b = UIUtils.createButton (Constants.OPTIONS_ICON_NAME,
                                  Constants.ICON_SIDEBAR,
                                  getUIString (editors,sidebar,headercontrols,items,config,tooltip),
                                  ...
                                  new ActionListener ()
                                  {
                                        ...
                                        public void actionPerformed (ActionEvent ev)
                                        {
                                            ...
                                            if (prevCount > 0)
                                            {
                                                ...
                                                popup.add (UIUtils.createMenuItem (String.format (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,previouscontacts,text),
                                                                                                    //"View the previous {contacts} (%s)",
                                          ...
                                          popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,updatenameavatar,text),
                                          ...
                                          popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,changepassword,text),
                                          ...
                                          if (!EditorsEnvironment.getEditorsPropertyAsBoolean (Constants.QW_EDITORS_SERVICE_HAS_LOGGED_IN_PROPERTY_NAME))
                                          {
                                            ...
                                            popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,resendaccountconfirmationemail,text),
                                            ...
                                            if (edPass != null)
                                            {
                                                ...
                                                popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,displaypassword,text),
                                              ...
                                              popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,resetpassword,text),
                                                                                //"Reset your password",
                                          ...
                                          popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,preferences,text),
                                                                            //"Preferences",
                                          ...
                                          popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,help,text),
                                                                            //"Help",
                                          ...
                                          popup.add (UIUtils.createMenuItem (getUIString (editors,sidebar,headercontrols,items,config,popupmenu,items,deleteaccount,text),
                                                                            //"Delete your account",
