...
import com.quollwriter.ui.fx.Stateful;
import com.quollwriter.ui.fx.State;

public abstract class QuollPanel<E extends AbstractProjectViewer> extends Box /*JRootPane*/ implements Stateful,
                                                                                               PopupsSupported
{
...
/*
        ...
        this.content.setBackground (SwingUIUtils.getComponentColor ());

        this.getContentPane ().setBackground (SwingUIUtils.getComponentColor ());
...
*/
    ...
    public abstract void init (State s)
...
*/
                                 ...
                                 String actionCommand)
    {
        ...
        JButton but = SwingUIUtils.createButton (icon,
                                            iconType,
                                            toolTipText,
                                            this.performAction);
