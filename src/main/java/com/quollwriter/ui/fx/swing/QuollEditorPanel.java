...
public class QuollEditorPanel extends AbstractEditableEditorPanel<ProjectViewer> implements ChapterItemViewer<ProjectViewer>
{
                     ...
                     throws GeneralException
    {
        ...
        this.highlight = new BlockPainter (SwingUIUtils.getHighlightColor ());
...
TODO Remove
        this.iconColumn.addMouseListener (new MouseEventHandler ()
        {
            ...
            public void handleDoublePress (MouseEvent ev)
            {
                ...
                mi = SwingUIUtils.createMenuItem (getUIString (prefix,Scene.OBJECT_TYPE),
                                             Scene.OBJECT_TYPE,
                              ...
                              public void actionPerformed (ActionEvent ev)
                              {
                                  ...
                                  } catch (Exception e)
                                  {
                                      ...
                                      ComponentUtils.showErrorMessage (_this.viewer,
                                                                       getUILanguageStringProperty (LanguageStrings.project,LanguageStrings.actions,showchapterinfo,actionerror));
...
/*
 TODO Remove
        iconColumn.setAlignmentY (Component.TOP_ALIGNMENT);
        iconColumn.setAlignmentX (Component.LEFT_ALIGNMENT);
        iconColumn.setMinimumSize (new Dimension (50, 200));
        iconColumn.setPreferredSize (new Dimension (50, 200));
        iconColumn.setMaximumSize (new Dimension (50, Integer.MAX_VALUE));


        JPanel pp = new ScrollablePanel (new BorderLayout ());
        JTextArea a = new JTextArea ("This is a test.");
        a.setLineWrap (true);
        a.setWrapStyleWord (true);
pp.setBorder (new javax.swing.border.LineBorder (java.awt.Color.green, 3));
        pp.add (iconColumn,
                BorderLayout.WEST);
        pp.add (a,
                BorderLayout.CENTER);
*/
    ...
    public void showProblemFinderRuleConfig ()
    {
         ...
         // TODO this.projectViewer.showProblemFinderRuleConfig ();
                             ...
                             final boolean  fullScreen)
    {
        ...
        // Add a tools menu.
        final JButton b = SwingUIUtils.createToolBarButton ("tools",
                                                       getUIString (prefix,
...
*/
                ...
                if (_this.viewer.isProjectLanguageEnglish ())
                {
...
REMOVE
        ...
        final JButton b = SwingUIUtils.createToolBarButton (Constants.NEW_ICON_NAME,
...
*/
           ...
           ComponentUtils.showErrorMessage (this.viewer,
                                            getUILanguageStringProperty (LanguageStrings.project,editorpanel,LanguageStrings.actions,seteditposition,actionerror));
                                       ...
                                       boolean    compress)
    {
        ...
        if (compress)
        {
            ...
            popup.add (SwingUIUtils.createPopupMenuButtonBar (getUIString (LanguageStrings.project,
                                                                                  LanguageStrings.editorpanel,
                                                                                  LanguageStrings.popupmenu,
                                                                                  Chapter.OBJECT_TYPE,
            ...
            buts.add (SwingUIUtils.createButton (Constants.EDIT_IN_PROGRESS_ICON_NAME,
                                            Constants.ICON_MENU,
                                            getUIString (prefix,
            ...
            popup.add (SwingUIUtils.createPopupMenuButtonBar (null,
                                                         popup,
                                                         buts));
            ...
            m.setIcon (SwingUIUtils.iconProvider.getIcon (Constants.EDIT_ICON_NAME,
                                            Constants.ICON_MENU));
            ...
            mi = SwingUIUtils.createMenuItem (getUIString (prefix,
                                                                  LanguageStrings.seteditposition,
                                                                  LanguageStrings.text),
                                                               //"Set Edit Point",
            ...
            JMenu nm = new JMenu (getUIString (LanguageStrings.project,
                                                          ...
                                                          LanguageStrings.text));
                                                          //"New");
            nm.setIcon (SwingUIUtils.iconProvider.getIcon (Constants.NEW_ICON_NAME,
                                             Constants.ICON_MENU));
...
*/
               ...
               ComponentUtils.showErrorMessage (_this.viewer,
                                                getUILanguageStringProperty (Arrays.asList (edititem,actionerror),
...
*/
       ...
       SwingUIUtils.doLater (new ActionListener ()
       {
          ...
          public void actionPerformed (ActionEvent ev)
          {
             ...
             try
             {
                ...
                ComponentUtils.showErrorMessage (_this.viewer,
                                                 getUILanguageStringProperty (Arrays.asList (viewitem, actionerror),
                                                                              Environment.getObjectTypeName (n)));
                                          //"Unable to show item, please contact Quoll Writer support for assistance.");
    ...
    public List<Component> getTopLevelComponents ()
    {
        ...
        return Arrays.asList (this.iconColumn, this.editor);
/*
...
*/
              ...
              throws GeneralException
   {
        ...
        this.problemFinderPanel.setBackground (SwingUIUtils.getComponentColor ());
        this.problemFinderPanel.setBorder (new MatteBorder (1,
                                                            0,
                                                            0,
                                                            0,
                                                            SwingUIUtils.getBorderColor ()));

        java.util.List<JButton> hbuts = new ArrayList<> ();

        hbuts.add (SwingUIUtils.createButton ("config",
                                        Constants.ICON_MENU,
                                        getUIString (prefix,
         ...
         ActionAdapter finishAction = new ActionAdapter ()
         {
             ...
             public void actionPerformed (ActionEvent ev)
             {
                 ...
                 _this.editor.setHighlightWritingLine (_this.viewer.isHighlightWritingLine ());
        ...
        hbuts.add (SwingUIUtils.createButton (Constants.CANCEL_ICON_NAME,
                                        Constants.ICON_MENU,
                                        getUIString (prefix,
                                                                 LanguageStrings.headercontrols,
                                                                 LanguageStrings.items,
        ...
        hbuts.add (SwingUIUtils.createHelpPageButton (this.viewer,
                                                      "chapters/problem-finder",
                                                Constants.ICON_MENU,
                                                null));

        JToolBar tb = SwingUIUtils.createButtonBar (hbuts);

        tb.setBorder (SwingUIUtils.createPadding (0, 0, 0, 5));

        Header h = SwingUIUtils.createHeader (getUIString (prefix,
...
TODO
        new ProblemFinder (this,
                                                ...
                                                this.projectViewer);
                                                */
        // TODO this.problemFinder.setAlignmentX (Component.LEFT_ALIGNMENT);

        // TODO this.problemFinderPanel.add (this.problemFinder);
        ...
        JButton prev = new JButton (SwingUIUtils.iconProvider.getIcon ("previous",
                                                         Constants.ICON_MENU));
        prev.addActionListener (new ActionAdapter ()
        {
            ...
            public void actionPerformed (ActionEvent ev)
            {
                ...
                } catch (Exception e)
                {
                    ...
                    ComponentUtils.showErrorMessage (_this.viewer,
                                                     getUILanguageStringProperty (Utils.newList (prefix,previouserror)));
        ...
        JButton next = SwingUIUtils.createButton (getUIString (prefix,
                                                                      LanguageStrings.buttons,
        ...
        next.addActionListener (new ActionAdapter ()
            {
                ...
                public void actionPerformed (ActionEvent ev)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        ComponentUtils.showErrorMessage (_this.viewer,
                                                         getUILanguageStringProperty (Utils.newList (prefix,nexterror)));
        ...
        JButton finish = SwingUIUtils.createButton (getUIString (prefix,
                                                                        LanguageStrings.buttons,
        ...
        this.ignoredProblemsLabel = SwingUIUtils.createClickableLabel ("",
                                                                  SwingUIUtils.iconProvider.getIcon ("warning",
                                                                                       Constants.ICON_MENU));
        this.ignoredProblemsLabel.setVisible (false);
        this.ignoredProblemsLabel.setBorder (SwingUIUtils.createPadding (0, 10, 0, 0));
...
*/
        ...
        buts.setBorder (SwingUIUtils.createPadding (10, 10, 7, 10));
   ...
   public void showProblemFinder ()
   {
      ...
      } catch (Exception e)
      {
         ...
         ComponentUtils.showErrorMessage (this.viewer,
                                          getUILanguageStringProperty (LanguageStrings.project,LanguageStrings.editorpanel,LanguageStrings.actions,problemfinder,actionerror));
...
*/
    ...
    public void setBackgroundColor (javafx.scene.paint.Color c)
    {
        ...
        Color _c = SwingUIUtils.toSwingColor (c);

        super.setBackgroundColor (c);

        if ((_c.equals (javafx.scene.paint.Color.WHITE))
            ||
            (_c.equals (SwingUIUtils.getComponentColor ()))
           )
        {
        ...
        } else
        {
            ...
            this.iconColumn.setBackground (_c);
