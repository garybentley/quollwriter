...
*/
        ...
        WordPainter wp = new WordPainter ()
        {
            ...
            public Paint paintFor (Word w)
            {
                ...
                if (w.getWeight () >= 0.7f)
                {
                    ...
                    return null; //UIUtils.getColor ("#DBC900");
                ...
                if (w.getWeight () >= 0.5f)
                {
                    ...
                    return null; // UIUtils.getColor ("#ED7D3A");
                ...
                if (w.getWeight () >= 0.3f)
                {
                    ...
                    return null; //UIUtils.getColor ("#348AA7");
        ...
        JScrollPane sp = null;//UIUtils.createScrollPane (b);
