 ...
 * @since 9
 */
public class QuollTreeViewSkin<T> extends SkinBase<TreeView<T>>
{
//VirtualContainerBase<TreeView<T>, TreeCell<T>> {
...
*/
     ...
     */
    public QuollTreeViewSkin(final TreeView control) {
        super(control);
...
//        int oldCount = flow.getCellCount();
    ...
    private int onScrollPageDown(boolean isFocusDriven) {
        TreeCell<T> lastVisibleCell = null; //flow.getLastVisibleCellWithinViewPort();
        ...
        if (isSelected) {
            ...
            if (isLeadIndex) {
                ...
                TreeCell<T> newLastVisibleCell = null; //flow.getLastVisibleCellWithinViewPort();
    ...
    private int onScrollPageUp(boolean isFocusDriven) {
        TreeCell<T> firstVisibleCell = null;//flow.getFirstVisibleCellWithinViewPort();
        ...
        if (isSelected) {
            ...
            if (isLeadIndex) {
                ...
                TreeCell<T> newFirstVisibleCell = null; //flow.getFirstVisibleCellWithinViewPort();
