...
public class TextInputWindow extends PopupWindow
{
    ...
    public TextInputWindow (AbstractViewer pv)
    {
        ...
        this.error = UIUtils.createErrorLabel (getUIString (form,errors,entervalue));
                                          ...
                                          final ActionListener onCancel)
    {
        ...
        JButton cancel = UIUtils.createButton ((cancelButtonLabel != null ? cancelButtonLabel : getUIString (LanguageStrings.buttons, LanguageStrings.cancel)),
                                               new ActionListener ()
        {
