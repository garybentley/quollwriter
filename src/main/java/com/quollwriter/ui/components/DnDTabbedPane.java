...
/**
 * Taken from http://java-swing-tips.blogspot.com/2008/04/drag-and-drop-tabs-in-jtabbedpane.html
 */
import java.awt.*;
...
public class DnDTabbedPane extends JTabbedPane
{
    ...
    private final Color          lineColor = new Color (0,
                                                        100,
                                                        255);
    ...
    public DnDTabbedPane()
    {
        ...
        final DragSourceListener  dsl = new DragSourceListener ()
        {
            ...
            public void dragExit (DragSourceEvent e)
            {
                ...
                lineRect.setRect (0,
                                  ...
                                  0,
                                  0);
                glassPane.setPoint (new Point (-1000,
                                               -1000));
                glassPane.repaint ();
            }
            ...
            public void dragOver (DragSourceDragEvent e)
            {
                ...
                SwingUtilities.convertPointFromScreen (glassPt,
                                                       glassPane);
        ...
        final DragGestureListener dgl = new DragGestureListener ()
        {
            public void dragGestureRecognized (DragGestureEvent e)
            {
                ...
                dragTabIndex = indexAtLocation (tabPt.x,
                                                tabPt.y);
    ...
    {
        Point   tabPt = SwingUtilities.convertPoint (glassPane,
                                                     glassPt,
                                                     DnDTabbedPane.this);
    ...
    private void convertTab (int prev,
                             int next)
    {
    ...
    private void initTargetLeftRightLine (int next)
    {
        ...
        } else if (next == 0)
        {
            Rectangle r = SwingUtilities.convertRectangle (this,
                                                           getBoundsAt (0),
                                                           glassPane);
            lineRect.setRect (r.x - (LINEWIDTH / 2),
                              r.y,
                              LINEWIDTH,
                              r.height);
        } else
        {
            Rectangle r = SwingUtilities.convertRectangle (this,
                                                           getBoundsAt (next - 1),
                                                           glassPane);
            lineRect.setRect (r.x + r.width - (LINEWIDTH / 2),
                              r.y,
                              LINEWIDTH,
                              r.height);
        }
    ...
    private void initTargetTopBottomLine (int next)
    {
        ...
        } else
        {
            Rectangle r = SwingUtilities.convertRectangle (this,
                                                           ...
                                                           glassPane);
            lineRect.setRect (r.x,
                              r.y + r.height - (LINEWIDTH / 2),
                              r.width,
                              LINEWIDTH);
        }
    }

    private void initGlassPane (Component c,
                                Point     tabPt)
    {
        ...
        if (hasGhost ())
        {
            ...
            image = image.getSubimage (rect.x,
                                       rect.y,
                                       rect.width,
                                       rect.height);
        ...
        Point glassPt = SwingUtilities.convertPoint (c,
                                                     tabPt,
                                                     glassPane);
