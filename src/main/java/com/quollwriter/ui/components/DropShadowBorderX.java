 ...
 * @author rbair
 */
public class DropShadowBorderX implements Border
{
    ...
    public DropShadowBorderX()
    {
        this (UIManager.getColor ("Control"),
              1,
              8);
    }

    public DropShadowBorderX(Color lineColor,
                             int   lineWidth,
                             int   shadowSize)
    {
        this (lineColor,
                             ...
                             int       height)
    {
        ...
        if (showLeftShadow || showTopShadow)
        {
            ...
            if (showLeftShadow && !showTopShadow)
            {
                topLeftShadowPoint.setLocation (x,
                                                y + shadowSize);
            ...
            {
                topLeftShadowPoint.setLocation (x + shadowSize,
                                                y);
            }
        }
        ...
        if (showLeftShadow || showBottomShadow)
        {
            ...
            if (showLeftShadow && !showBottomShadow)
            {
                bottomLeftShadowPoint.setLocation (x,
                                                   y + height - shadowSize - shadowSize);
            ...
            {
                bottomLeftShadowPoint.setLocation (x + shadowSize,
                                                   y + height - shadowSize);
            }
        }
        ...
        if (showRightShadow || showBottomShadow)
        {
            ...
            if (showRightShadow && !showBottomShadow)
            {
                bottomRightShadowPoint.setLocation (x + width - shadowSize,
                                                    y + height - shadowSize - shadowSize);
            ...
            {
                bottomRightShadowPoint.setLocation (x + width - shadowSize - shadowSize,
                                                    y + height - shadowSize);
            }
        }
        ...
        if (showRightShadow || showTopShadow)
        {
            ...
            if (showRightShadow && !showTopShadow)
            {
                topRightShadowPoint.setLocation (x + width - shadowSize,
                                                 y + shadowSize);
            ...
            {
                topRightShadowPoint.setLocation (x + width - shadowSize - shadowSize,
                                                 y);
            }
        }
        ...
        if (showLeftShadow)
        {
            Rectangle leftShadowRect = new Rectangle (x,
            ...
            g2.drawImage (images.get (Position.LEFT),
                          leftShadowRect.x,
                          leftShadowRect.y,
                          leftShadowRect.width,
                          leftShadowRect.height,
                          null);
        }
        ...
        if (showBottomShadow)
        {
            ...
            g2.drawImage (images.get (Position.BOTTOM),
                          bottomShadowRect.x,
                          bottomShadowRect.y,
                          bottomShadowRect.width,
                          bottomShadowRect.height,
                          null);
        }
        ...
        if (showRightShadow)
        {
            ...
            g2.drawImage (images.get (Position.RIGHT),
                          rightShadowRect.x,
                          rightShadowRect.y,
                          rightShadowRect.width,
                          rightShadowRect.height,
                          null);
        }

        if (showTopShadow)
        {
            Rectangle topShadowRect = new Rectangle (topLeftShadowPoint.x + shadowSize,
                                                     y,
        ...
        if (showLeftShadow || showTopShadow)
        {
            g2.drawImage (images.get (Position.TOP_LEFT),
                          topLeftShadowPoint.x,
                          topLeftShadowPoint.y,
                          null);
        }
        ...
        if (showLeftShadow || showBottomShadow)
        {
            g2.drawImage (images.get (Position.BOTTOM_LEFT),
                          bottomLeftShadowPoint.x,
                          bottomLeftShadowPoint.y,
                          null);
        }
        ...
        if (showRightShadow || showBottomShadow)
        {
            g2.drawImage (images.get (Position.BOTTOM_RIGHT),
                          bottomRightShadowPoint.x,
                          bottomRightShadowPoint.y,
                          null);
        }
        ...
        if (showRightShadow || showTopShadow)
        {
            g2.drawImage (images.get (Position.TOP_RIGHT),
                          topRightShadowPoint.x,
                          topRightShadowPoint.y,
                          null);
        }
    ...
    private Map<Position, BufferedImage> getImages ()
    {
        ...
        if (images == null)
        {
            ...
            RoundRectangle2D rect = new RoundRectangle2D.Double (0,
                                                                 0,
                                                                 rectWidth,
                                                                 rectWidth,
                                                                 cornerSize,
            ...
            buffer.setColor (new Color (((float) this.shadowColor.getRed () / 255f),
                                        ((float) this.shadowColor.getGreen () / 255f),
                                        ((float) this.shadowColor.getBlue () / 255f),
                                        shadowOpacity));

/*
            buffer.setColor (new Color (0.0f,
                                        0.0f,
                                        0.0f,
                                        shadowOpacity));
                                        */
            buffer.translate (shadowSize,
                              shadowSize);
            buffer.fill (rect);
            buffer.dispose ();
            ...
            ConvolveOp    blur = new ConvolveOp (new Kernel (shadowSize,
                                                             shadowSize,
                                                             blurKernel));
            BufferedImage targetImage = new BufferedImage (imageWidth,
                                                           imageWidth,
                                                           BufferedImage.TYPE_INT_ARGB);
            ((Graphics2D) targetImage.getGraphics ()).drawImage (image,
                                                                 blur,
                                                                 -(shadowSize / 2),
                                                                 -(shadowSize / 2));
            ...
            int w = shadowSize;
            int h = shadowSize;
            images.put (Position.TOP_LEFT,
                        getSubImage (targetImage,
                                     x,
                                     y,
                                     w,
                                     h));
            ...
            w = shadowSize;
            h = shadowSize;
            images.put (Position.BOTTOM_LEFT,
                        getSubImage (targetImage,
                                     x,
                                     y,
                                     w,
            ...
            w = shadowSize;
            h = shadowSize;
            images.put (Position.BOTTOM_RIGHT,
                        getSubImage (targetImage,
                                     x,
                                     y,
                                     w,
    ...
    private static BufferedImage getSubImage (BufferedImage img,
                                              ...
                                              int           h)
    {
        BufferedImage ret = new BufferedImage (w,
                                               h,
                                               BufferedImage.TYPE_INT_ARGB);
    ...
    {
        int top = showTopShadow ? shadowSize : lineWidth;
        int left = showLeftShadow ? shadowSize : lineWidth;
        int bottom = showBottomShadow ? shadowSize : lineWidth;
        int right = showRightShadow ? shadowSize : lineWidth;
